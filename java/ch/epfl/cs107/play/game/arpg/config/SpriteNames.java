...
public abstract class SpriteNames {
    ...
    public static final String HEART_ITEM = "";
    public static final String FIRE_SPELL_ITEM = "";
    public static final String CASTLE_KEY_ITEM = "zelda/key";
    public static final String BOMB_ITEM = "zelda/bomb";
    public static final String BOW_ITEM = "zelda/bow.icon";
